...
Produces a set of header files as output: definitions.hh, conv_weights.hh,
dense_weights.hh.
...
def save_param_on_files(model: Sequential) -> None:
	...
	model 'model'.
	Writes on 'definitions.hh', 'conv_weights.hh' ,'dense_weights.hh' files.
	'''

	# definitions.hh
	with open('../C++/definitions.hh', 'w') as f:
		print('writing \'definitions.hh\' file... ', end='')
	...
	with open('../C++/conv_weights.hh', 'w') as f:
		print('writing \'conv_weights.hh\' file... ', end='')
		print('/*\n * This file is auto-generated by gen-weights.py\n */\n',file=f)
	...
	with open('../C++/dense_weights.hh', 'w') as f:
		print('writing \'dense_weights.hhh\' file... ', end='')
		print('/*\n * This file is auto-generated by gen-weights.py\n */\n',file=f)
		print('#pragma once\n\n#include "definitions.hhh"\n\n', file=f)
