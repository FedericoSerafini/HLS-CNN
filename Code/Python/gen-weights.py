...
def save_param_on_file(model):
	...
	with open('../C/definitions.h', 'w') as f:
		...
		# save conv_1 constant
		print('// CONV layer',file=f)
		...
		print('#define KRN_FILTERS\t',end='',file=f)
		print(conv_1_filter_num, file=f)
		print('#define\tPAD_ROWS (KRN_ROWS - 1)',file=f)
		print('#define\tPAD_COLS (KRN_COLS - 1)',file=f)

	# weights.h
	with open('../C/weights.h', 'w') as f:
		print('/*\n* This file is auto-generated by gen-weights.py\n*/\n',file=f)
		print('#pragma once\n\n#include "definitions.h"\n\n',file=f)
		# save conv_1 weights and bias
		biases, weights = get_params(model.layers[1])
		# conv weights
		print('const float krn_filters [KRN_FILTERS][KRN_ROWS][KRN_COLS]\n\t= {',file=f)
		...
		# conv biases
		print('const float krn_biases [KRN_FILTERS] = { ', file=f, end='')
